...
async function fetchMovies(name) {
  const response = await fetch(
    `http://www.omdbapi.com/?apikey=e54db17c&s=${name}`
  );
  const result = await response.json();
  console.log(result);
  loadMovies(result);
}
function loadMovies(result = "") {
  movies =
    result != ""
      ? result.Search
      : [
          ...
          },
          {
            ...
            Type: "movie",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BMjAxNjcyNDQxM15BMl5BanBnXkFtZTgwNzU2NDA0MDE@._V1_SX300.jpg",
          },
          {
            ...
            Type: "movie",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BMjE0NDk2NjgwMV5BMl5BanBnXkFtZTYwMTgyMzA3._V1_SX300.jpg",
          },
          {
            Title: "Inside Job",
            Year: "2010",
          ...
          },
          {
            ...
            Type: "movie",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BNTgyODRlNjQtMGZhNS00ZTA3LTgyNjgtNDYwNWM1ZDI0ODMzXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg",
          },
          {
            ...
            Type: "movie",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BMTYwOTg1MTk0NF5BMl5BanBnXkFtZTcwMTA5NTI5Ng@@._V1_SX300.jpg",
          },
          {
            ...
            Type: "movie",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BMTUyOTIwMTU5MV5BMl5BanBnXkFtZTcwNDY5NjA1Mw@@._V1_SX300.jpg",
          },
          {
            Title:
            ...
            Type: "series",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BYTgyZmYzM2YtZDQ3YS00ODJhLWIyYzEtN2QzYjA5YTZjZGM0XkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg",
          },
          {
            Title: "Inside No. 9",
            Year: "2014–",
            ...
            Type: "series",
            Poster:
              "https://m.media-amazon.com/images/M/MV5BYTY1Y2UzMmItZDgzMC00Nzc1LTk3ZDAtYWM4MGFhNzdkYzU1XkEyXkFqcGdeQXVyMjQ1NjEyNzE@._V1_SX300.jpg",
          },
        ];
